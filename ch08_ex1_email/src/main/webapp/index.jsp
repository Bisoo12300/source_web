...
<body>
    ...
    <form action="emailList" method="post">
        ...
        <label>&nbsp;</label>
        <input type="submit" value="Join Now" class="margin_left"><br><br>
        <input type="submit" value="Back home" onclick="location.href='https://bisoo12300.github.io/home/'">
    </form>
</body>
<footer>
<p>© Copyright  Mike Murach &amp; Associates</p>
</footer>
</html>